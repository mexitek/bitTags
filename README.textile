...
// Test matchNone()
bt.matchAll( ['a','b','c','d'], ['e','f','g','h'] );     //returns: true
bt.matchAll( ['a','b','c','d'], ['a','b','c'] );         //returns: false
bt.matchAll( ['a','b','c','d'], ['sunshine','b','cat','z'] ); //returns: false
bt.matchAll( ['small','ball','3','$'] );                 //returns: true
</pre>
